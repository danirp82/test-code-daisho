...
/* harmony import */ var _core_guards_home_guard_guard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./core/guards/home-guard.guard */ "./src/app/core/guards/home-guard.guard.ts");
...
var routes = [
    { path: '', loadChildren: './components/home/home.module#HomeModule', canActivate: [_core_guards_home_guard_guard__WEBPACK_IMPORTED_MODULE_2__["HomeGuardGuard"]] },
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HTTP_INTERCEPTORS"], useClass: _core_helpers_jwt_interceptor__WEBPACK_IMPORTED_MODULE_6__["JwtInterceptor"], multi: true },
...
/***/ "./src/app/core/guards/home-guard.guard.ts":
/*!*************************************************!*\
  !*** ./src/app/core/guards/home-guard.guard.ts ***!
  \*************************************************/
...
var HomeGuardGuard = /** @class */ (function () {
    function HomeGuardGuard(router, authenticationService) {
        this.router = router;
        this.authenticationService = authenticationService;
    }
    HomeGuardGuard.prototype.canActivate = function (route, state) {
...
module.exports = __webpack_require__(/*! /Users/dlru/Documents/Projects/daisho-app/src/main.ts */"./src/main.ts");
